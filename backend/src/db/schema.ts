...
export const AUDIT_EVENT_TYPES = [
  ...
  // D-21 (Accepted 2026-09-05): seller fact replacement and seller draft saves are consequential.
  ...
  'ACCESS_CODE_REVOKED',
  'ACCESS_CODE_EXPIRED',
  // D-19 (Accepted 2026-09-04): seller authentication events (AUTH-217, AUTH-206).
