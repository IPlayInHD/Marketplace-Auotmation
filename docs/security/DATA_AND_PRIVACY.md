...
| DATA-324 | Region selection for the database, object storage and the model provider is deferred with the stack (`D-08`), but is a **privacy decision as well as a latency one** and must be recorded as such in the superseding decision. |
